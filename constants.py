...
class Screen():
  ...
  ALL_SCREENS = (
      CANDLE_BLOCKED_CAVE_SCREENS + BOMB_BLOCKED_CAVE_SCREENS + OPEN_CAVE_SCREENS +
      RAFT_BLOCKED_CAVE_SCREENS +  # POWER_BRACELET_BLOCKED_CAVE_SCREENS +
      RECORDER_BLOCKED_CAVE_SCREENS)
